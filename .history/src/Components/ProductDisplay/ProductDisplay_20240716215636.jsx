    ...
    <div className="productdisplay">
      ...
      <div className="productdisplay-right">
       ...
       <p>(122)</p>
        ...
        <p className="productdisplay-right-category"> <span>Caategory:</span>Women,T-Shirt,Crop</p>
        <p className="productdisplay-right-category"> <span>Tags:</span>Women,T-Shirt,Crop</p>
      </div>
    </div>
  );
};
